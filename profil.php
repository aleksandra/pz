...
?>
			...
			<?php if ($_SESSION['typ'] == 'f') { ?>
                                        ...
                                        <img src="img/panel2.jpg"><br />
										<a id="zmien_haslo"> <img src="img/haslo.jpg"> </a><br />
										
                                        
                              <?php      }  ?>
                                     	
			<?php if( $_SESSION['typ'] == 'p') { ?>
			<img src="img/panel1.jpg"><br />
			<a id="zmien_haslo"> <img src="img/haslo.jpg"> </a><br />
			<a href="cv.php?id=<?php echo $_SESSION['id_obecne']; ?>"> <img src="img/show2.jpg"> </a> <br />
			<a href="edytuj_cv.php"> <img src="img/edit2.jpg"> </a> <br />
			<a id="ogloszenia"> <img src="img/ur_oglo.jpg"> </a> <!--narazie nico -->
			<?php } ?>				</td><td>			  
				...
				<p>Zarejestrowany od: <?php echo $dolaczyl; ?>
							<div id="zmien_haslo_div" <?php  if ($_SESSION['pokaz'] != 1 ) {echo 'style="display:none"';} $_SESSION['pokaz'] = 0;?> ><fieldset>
			...
			<div id="ogloszenia_div" style="display:none" ><center>
